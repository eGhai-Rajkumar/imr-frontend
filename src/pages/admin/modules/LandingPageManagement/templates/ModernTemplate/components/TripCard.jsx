...
export default function TripCard({ trip, index, onEnquire, onViewDetails, primaryColor = '#2C6B4F', secondaryColor = '#D4AF37' }) {
    ...
    >
      ...
      <div className="flex-1 p-6 flex flex-col justify-between bg-white relative z-10">
        ...
        <div>
          ...
          <h3
            className="text-xl font-black text-slate-900 leading-tight line-clamp-2 group-hover:text-[#D4AF37] transition-colors duration-300"
