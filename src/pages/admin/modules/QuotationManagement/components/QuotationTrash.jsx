            ...
            <Table>
              ...
              <TableBody>
                ...
                {trashed.length === 0 ? (
                  ...
                  trashed.map((q, idx) => {
                    // Robust extraction: trash rows may contain nested lead object or different field names
                    const clientName = q.__client_name || q.client_name || q.lead?.client_name || q.lead?.name || q.lead_info || 'N/A';
                    const clientEmail = q.__client_email || q.client_email || q.lead?.client_email || q.lead?.email || null;
                    const clientMobile = q.__client_mobile || q.client_mobile || q.lead?.client_mobile || q.lead?.mobile || null;

                    const deletedAt = q.updated_at || q.deleted_at || q.created_at || null;
                    const deletedAtStr = safeFormatDate(deletedAt);
                    ...
                    return (
                      <TableRow key={q.id} hover>
                        ...
                        <TableCell>
                          <Typography variant="caption">{deletedAtStr}</Typography>
                        </TableCell>
